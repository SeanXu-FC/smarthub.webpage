    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            for (var index in json) {
                ...
                str += '<tr><td class="czjz">country Code:</td><td><select name="type" class="form-control select_03 countryCode" value="' + json[index].CountryCode + '"  style="width:80%"></select></td></tr>';
